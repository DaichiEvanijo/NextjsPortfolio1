const AccordionData = [
  ...
  {
    language:"React.js",
    keywords:"State Management (Redux toolkit, useContext API), useCallback, useMemo, React.memo, useReducer, useDebounce, useLocalStorage, React-Bootstrap, Intersection Observer API, Axios, Thunder client and other basics..."
  },
  {
    language:"CSS",
    keywords:"Tailwind CSS, Dark mode with Tailwind CSS, twMerge, clsx, Class-Variant-Authority, Bootstrap,  Dark mode with React-Bootstrap,  SCSS basics and other basics..."
  },
  {
    language:"Backend skills",
    keywords:"Node.js/Express.js (JWT Authentication/Authorization with accessToken/refreshToken, Role-based authorization,  Basic API creations,  middleware,  nodemailder,  CORS),  MongoDB (basic CRUD operation with Mongoose ), Cloudinary (image upload/delete)"
  },
  {
    language:"Others",

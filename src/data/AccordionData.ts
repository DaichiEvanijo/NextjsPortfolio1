const AccordionData = [
  ...
  {
    language:"React.js",
    keywords:"State Management (Redux toolkit, useContext API), useCallback, useMemo, React.memo, useReducer, useImperativeHandler, useDebounce, useLocalStorage, react-error-boundary, React-Bootstrap, Basics of Testing (Jest, React Testing Library (Unit Test, Integration Test,  Mock Service Worker, E2E Test)) Intersection Observer API, Axios, Thunder client and other basics..."
  },
  {
    language:"CSS",

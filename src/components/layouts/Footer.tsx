  ...
  return (
    <footer className=" bg-gradient-to-r from-blue-200 via-yellow-200 to-blue-200 p-10 space-y-4 ">
      <section className="mx-auto text-center max-w-4xl grid grid-cols-1 md:grid-cols-3 ">
        ...
        <div className="border-2 rounded border-slate-300 flex flex-col gap-2">
          ...
          <Link href="https://www.youtube.com" target="_blank">
            <FaYoutube size={24} className="inline mr-2" />
            <span>Youtube</span>
          </Link>
          <Link href="#" target="_blank">
            <FaInstagram size={24} className="inline mr-2" />
            <span>Instagram</span>
          </Link>
          <Link href="#" rel="noopener noreferrer" target="_blank">
            <FaTelegramPlane size={24} className="inline mr-2" />
            <span>Telegram</span>
          </Link>
        </div>
      </section>
      <section className="text-center">
        <p>
          <span>&copy;{new Date().getFullYear()} -Daichi Koyanagi- </span>
          <span>
